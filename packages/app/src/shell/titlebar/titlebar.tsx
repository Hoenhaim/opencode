      ...
      <Switch>
        <Match when>
          {(_) => {
            ...
            return (
              <div
                class="h-full flex-1 overflow-visible flex flex-row items-center gap-1.5 px-2 md:pe-3"
                classList={{
              ...
              >
                ...
                <Show when={!mobile()}>
                  <Tooltip placement="bottom" value={language.t("command.sidebar.toggle")} class="shrink-0">
                    <IconButton
                      type="button"
                      variant="ghost-muted"
                      size="large"
...
function ChannelIndicator(props: {
  ...
  if (!channel || channel === "prod" || channel === "dev") return null
